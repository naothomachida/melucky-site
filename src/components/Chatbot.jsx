    ...
    <div className="fixed bottom-4 sm:bottom-8 left-4 sm:left-8 z-50">
              ...
              <div className="flex flex-col gap-2 mt-4">
                {questions[currentQuestion].options?.map((option, index) => (
                  <button
                    ...
                    className="bg-white hover:bg-primary-50 text-gray-900 border-2 border-gray-200 rounded-xl px-4 py-3 text-sm font-medium transition-all duration-300 hover:border-primary-500 text-left cursor-pointer"
                  >
                    {option.text}
                  </button>
                ))}
          ...
          {isChatStarted && !conversationEnded && questions[currentQuestion]?.inputType && (
            <form onSubmit={handleInputSubmit} className="p-3 sm:p-4 bg-white border-t border-gray-200">
              <div className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="bg-slate-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl hover:bg-slate-600 transition-colors flex-shrink-0 cursor-pointer"
                >
          ...
          {conversationEnded && (
            <div className="p-4 bg-white border-t border-gray-200">
              <button
                ...
                className="w-full bg-green-500 hover:bg-green-600 text-white px-6 py-4 rounded-xl font-semibold flex items-center justify-center gap-3 transition-colors duration-300 cursor-pointer"
              >
      ...
      <div className="flex items-center gap-4">
        ...
        {showAvatar && !isOpen && (
          <button
            onClick={toggleChat}
            className="relative group animate-scale-in cursor-pointer"
          >
        ...
        {!isOpen && showBubble && !bubbleDismissed && (
          ...
          >
            ...
            <button
              ...
              className="absolute -top-2 -right-2 w-6 h-6 bg-slate-700 text-white rounded-full hover:bg-slate-600 transition-colors duration-300 flex items-center justify-center cursor-pointer"
            >
